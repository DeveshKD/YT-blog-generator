...
class Agents:
    ...
    def generate_blog(self, state: BlogGenState) -> BlogGenState:
        ...
        content_prompt = [
            ...
            IMPORTANT: YOU SIMPLY ONLY CREATE CONTENT FOR THE BLOG. THE TITLE IS ALREADY PROVIDED. DO NOT ADD ANY LINKS IN THE BLOG CONTENT. DO NOT ADD EMOJIES UNLESS THE USER EXPLICITLY ASKED FOR IT.
